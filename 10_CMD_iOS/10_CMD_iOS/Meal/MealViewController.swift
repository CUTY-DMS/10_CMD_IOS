...
class MealViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        dayView.snp.makeConstraints{
            $0.top.equalTo(subView.snp.bottom).offset(80)
        ...
        scrollView.snp.makeConstraints{
            $0.top.equalTo(view.safeAreaLayoutGuide.snp.top).offset(247)
            $0.right.left.equalToSuperview().inset(32)
            $0.bottom.equalTo(view.safeAreaLayoutGuide.snp.bottom).inset(171)
        }
